...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newArray = new int[]{
                ...
                R.id.bow_pose_1,R.id.bridge_pose_2,R.id.chair_pose_3,
                R.id.child_pose_4,R.id.cobbler_pose_5,R.id.cow_pose_6,
                R.id.playji_pose_7,R.id.pauseji_pose_8,R.id.plank_pose_9,
                R.id.crunches_pose_10,R.id.situp_pose_11,R.id.rotation_pose_12,
                R.id.twisht_pose_13,R.id.windmill_pose_14,R.id.legup_pose_15,
